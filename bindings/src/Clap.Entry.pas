...
type
PClapPluginEntry    =   ^TClapPluginEntry;
TClapPluginEntry    =   packed record
    ...
    procInit        :   function(const pluginPath: PAnsiChar): Boolean; cdecl;
    ...
    //
    // [thread-safe]
    procGetFactory  :   function(const factoryId: PAnsiChar): Pointer; cdecl;   //TODO
